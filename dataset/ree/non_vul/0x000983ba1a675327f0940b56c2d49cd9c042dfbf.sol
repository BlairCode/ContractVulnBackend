 ...
 return ( interfaceID == this.supportsInterface.selector || interfaceID == 0x5b5e139f || interfaceID == 0x6466353c || interfaceID == 0x780e9d63 );
 }
 ...
 user: msg.sender, count: packCount, commit: uint64(block.number), randomness: 0, current: 0 }
 );
 ...
 function getComponents( uint16 i, uint8 j, uint rand ) internal returns ( uint random, uint32 rarityRandom, uint16 purityOne, uint16 purityTwo, uint16 protoRandom ) {
