 ...
 constructor( testnetERC20 _test, address _devaddr, uint256 _testPerBlock, uint256 _startBlock, uint256 _bonusEndBlock ) public {
 test = _test;
 devaddr = _devaddr;
 ...
 lpToken: _lpToken, allocPoint: _allocPoint, lastRewardBlock: lastRewardBlock, accTestPerShare: 0 }
 ));
 }
 }
