 ...
 function getTeam(uint _teamId) public view returns ( string name, address ownerAddress, uint256 curPrice ) {
 Team storage _team = teams[_teamId];
 name = _team.name;
 ownerAddress = _team.ownerAddress;
 curPrice = _team.curPrice;
 }
 function getPlayer(uint _playerId) public view returns ( string name, address ownerAddress, uint256 curPrice, uint256 realTeamId ) {
