 ...
 contract BZRxToken is Ownable, BaseToken( 1000000000000000000000000000, "BZRX-Fake Protocol Token", 18, "BZRXFAKE" ) {
 function renameToken( string _newName, string _newSymbol ) public onlyOwner {
 name = _newName;
 symbol = _newSymbol;
 }
 }